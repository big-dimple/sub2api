...
func (s *RateLimitService) PreCheckUsage(_ context.Context, account *Account, _ string) (bool, error) {
...
func (s *RateLimitService) PreCheckUsageBatch(_ context.Context, accounts []*Account, _ string) (map[int64]bool, error) {
...
func (s *RateLimitService) handle429(ctx context.Context, account *Account, headers http.Header, responseBody []byte) {
	if account.Platform == PlatformGemini {
		slog.Info("gemini_429_passthrough", "account_id", account.ID, "reason", "platform_side_rate_limit_disabled")
		return
	}
