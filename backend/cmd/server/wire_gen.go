...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, func(), error) {
	...
	settingHandler := admin.NewSettingHandler(settingService, emailService, externalAuthProvider, turnstileService, opsService, paymentConfigService, paymentService, userAttributeService)
