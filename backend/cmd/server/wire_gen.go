...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, func(), error) {
	...
	authService := service.NewAuthService(userRepository, externalAuthProvider, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService)
