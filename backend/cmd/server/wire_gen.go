...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, func(), error) {
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, externalAuthProvider, turnstileService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService)
